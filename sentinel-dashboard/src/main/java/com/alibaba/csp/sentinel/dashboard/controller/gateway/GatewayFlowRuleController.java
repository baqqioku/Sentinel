...
public class GatewayFlowRuleController {
    ...
    private DynamicRuleProvider<List<GatewayFlowRuleEntity>> apiProvider;
    //实现的DynamicRulePublisher类
    @Autowired
    @Qualifier("gatewayFlowRuleNacosPublisher")
    private DynamicRulePublisher<List<GatewayFlowRuleEntity>> apiPublisher;
    ...
    public Result<List<GatewayFlowRuleEntity>> queryFlowRules(String app, String ip, Integer port) {
        ...
        try {
            ...
            List<GatewayFlowRuleEntity> rules = apiProvider.getRules(app);
